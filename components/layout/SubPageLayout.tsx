 ...
 *   2. 서브 비주얼 sub_flash_01.jpg 1000x196  "빠르고 간편한 자동차 대출! / 즉시대출 신용조회 무!!"
 *   3. 49px 여백 스트립(bm_bg.gif)
 *   4. 본문 2컬럼
 *        좌: 221px 컬럼 안에 190px 사이드바(섹션 타이틀 + 좌측 메뉴 + SMS 폼)
 *        우: 779px 컬럼 – 상단 3단 배너 → 7px → 파란 테두리(2px #3281C3) 콘텐츠 박스(770px)
 *              박스 내부: [› 아이콘 26x15][페이지 제목(굵은 검정 16px)]
 *                          [center_copy.gif 293x15 "차만 있으시면 무조건 대출이 가능합니다!"]
 *                          [730px 본문 = children]
 *   5. 푸터(441px)                     ← app/layout.tsx 의 <Footer/>
 *   + 우측 여백 상단 채팅상담 아이콘
 */
    ...
    <div className="relative mx-auto w-[1000px]">
      ...
      <Placeholder width={1000} height={196} note="sub_flash_01.jpg" tone="light" align="left">
        <div className="pl-[360px]">
          <div className="text-[24px] font-bold text-[#e0322e]">빠르고 간편한 자동차 대출!</div>
          <div className="text-[22px] font-bold text-[#1c5aa8]">즉시대출 신용조회 무!!</div>
          <div className="mt-1 text-[11px] text-[#999]">(노트북·지구본·빌딩 일러스트 배경)</div>
        </div>
      </Placeholder>
      ...
      {/* + 우측 여백 채팅상담 아이콘 (원본: 3열 우측 컬럼, 배너 아래 18px 지점) */}
      <div className="absolute left-full top-[calc(196px+49px+18px)] pl-[5px]">
        <ChatQuickIcon />
      </div>
          ...
          <section className="w-[770px] border-2 border-[#3281C3] bg-white">
            <div className="mx-auto w-[760px] pt-[7px]">
              ...
              <Placeholder width={293} height={15} note="center_copy.gif" tone="none" align="left">
                <span className="text-[11px] text-[#777]">차만 있으시면 무조건 대출이 가능합니다!</span>
              </Placeholder>
            </div>
